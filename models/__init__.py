...
__all__ = [
    ...
    'CartoonganDiscriminator', 'CartoonganDiscriminator'
]

_GAN_TYPES_ALLOWED = ['pggan', 'stylegan', 'stylegan2', 'cartoongan']
...
def build_generator(gan_type, resolution, **kwargs):
    ...
    if gan_type == 'stylegan':
        return StyleGANGenerator('styleganinv_ffhq256', **kwargs)
...
def parse_gan_type(module):
    ...
    if isinstance(module, (StyleGAN2Generator, StyleGAN2Discriminator)):
        return 'stylegan2'
    if isinstance(module, (CartoonganGenerator, CartoonganDiscriminator)):
        return 'cartoongan'
